...
{
private:
	_BaslerUSBCamera* device; ///< actual camera pointer as Basler device
...
public:
	...
	*/
	bool setExposureMode(std::string mode);
	...
	*/
	bool setExposure(const double time);
	...
	*/
	void loadFeatureFile(const std::string filename);
};
