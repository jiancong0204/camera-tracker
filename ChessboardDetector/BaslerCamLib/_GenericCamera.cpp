...
bool _GenericCamera::setExposureMode(ExposureModes mode)
{
	exposureMode = mode;
	if (mode == AUTO)
	{
...
bool _GenericCamera::laserExposure(cv::Mat& image)
{
	bool good = false;
